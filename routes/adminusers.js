...
const { getUserProfile, updateUserProfile, verifyWorker, getPendingVerifications, searchUsersByLocation, getAllUsers, deleteUser } = require('../controllers/users');
...
router.get('/all', auth(['admin']), getAllUsers); // New: Get all users
router.delete('/:userId', auth(['admin']), deleteUser); // New: Delete user
